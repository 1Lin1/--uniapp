<template>  
    <view class="container">  
		...
		<view class="user-section">
			<image class="bg" src="/static/yinghua.jpg"></image>
			<view class="user-info-box">
				...
				<view class="info-box">
					...
					<button  type="primary" @click="navTo" v-if="!hasLogin">点击登录</button>
				</view>
				<!-- #endif -->
				...
				<view class="info-box">
					...
					<button  type="primary" open-type="getUserInfo" @getuserinfo="wxGetUserInfo" v-if="!hasLogin">点击登录</button>
				</view>
				<!-- #endif -->
			</view>
		...
		>
			...
			<view class="tj-sction">
				<view class="tj-item">
					<text class="num">{{currentMoney}}</text>
					<text>余额</text>
				</view>
				<view class="tj-item">
					<text class="num">{{currentYHJ}}</text>
					<text>优惠券</text>
				</view>
				<view class="tj-item">
					<text class="num">{{currentJF}}</text>
					<text>积分</text>
				</view>
			</view>
			<!-- 订单 -->
...
<script>  
    ...
    export default {
        ...
        methods: {
			...
			wxGetUserInfo(){
				console.log('登录小程序')
               this.$store.dispatch('_toGetUserInfo').then(res => {
				   //登录后返回
			   })
			},
			
			//获取登录cookie
			_toGetUserInfoStroage(){
				uni.getStorage({
				    key: 'userInfo',
				    success: res => {
