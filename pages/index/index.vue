<template>
	<view class="container">
		...
		<view class="carousel-section">
			...
			<!-- 背景色区域 -->
			<view class="titleNview-background" :style="{backgroundColor:white}"></view>
		...
		<view class="group-section">
			<swiper class="g-swiper" :duration="500" autoplay>
				<swiper-item
					class="g-swiper-item"
					v-for="(item, index) in goodsList" :key="index"
					v-if="index%2 === 0"
...
<script>
	import {getHomeData,getGoodsList} from '../../apis/home.js'
	...
	export default {
		...
		methods: {
			...
			async LoadData() {
				...
				let carouselList = data.banner.list
				// this.titleNViewBackground = carouselList[0].background;
				this.swiperLength = carouselList.length;
				this.carouselList = carouselList;
				
				let goodsListData = await getGoodsList()
